    ...
    try {
      ...
      const orderItems = items.map(item => ({
        ...
        selected_options: item.selectedOptions.map(o => ({
          ...
          quantity: o.quantity,
          option_type: o.option.option_type,
          reinforcement_length: o.option.option_type === 'reinforcement' ? o.reinforcementLength : null,
          reinforcement_width: o.option.option_type === 'reinforcement' ? o.reinforcementWidth : null,
          fitting_distance: o.option.option_type === 'buckle' ? o.fittingDistance : null,
        })),
