    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-sm p-8 lg:p-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">BOXPACKプライバシーポリシー</h1>

          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              <p className="mb-4">
              株式会社キャムズ（以下「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
              </p>
            </section>
            ...
            <section>
              ...
              <ol className="ml-4 space-y-1">
                ...
                <li>(8) 配送手配および配送状況の確認のため</li>
                <li>(9) 商品の在庫管理および発注管理のため</li>
                <li>(10) マーケティングデータの調査・分析、新サービス開発のため</li>
                <li>(11) 上記の利用目的に付随する目的</li>
              </ol>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第9条（Cookieおよびアクセス解析ツール）</h2>
              <ol className="list-decimal pl-4">
                <li>本サービスは、Cookie（クッキー）を使用することがあります。Cookieとは、ウェブサイトを利用したときに、ブラウザとサーバーとの間で送受信した利用履歴や入力内容などを、お客様のコンピュータにファイルとして保存しておく仕組みです。</li>
                <li>ユーザーはブラウザの設定によりCookieの受け取りを拒否することができます。ただし、Cookieを拒否した場合、本サービスの一部の機能をご利用いただけない場合があります。</li>
                <li>当社は、ユーザーによる本サービスの利用状況を把握するため、Google Analyticsなどのアクセス解析ツールを使用することがあります。これらのツールは、トラフィックデータの収集のためにCookieを使用します。このトラフィックデータは匿名で収集されており、個人を特定するものではありません。</li>
              </ol>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第10条（プライバシーポリシーの変更）</h2>
              <ol className="list-decimal pl-4">
            ...
            <div className="pt-8 border-t border-gray-200">
              ...
              <p className="text-sm text-gray-600">最終改定日：2025年1月1日</p>
            </div>
          </div>
