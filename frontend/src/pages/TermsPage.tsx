    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-sm p-8 lg:p-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">BOXPACK 利用規約</h1>

          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              <p>
              この利用規約（以下「本規約」といいます。）は、株式会社キャムズ（以下「当社」といいます。）がこのウェブサイト上で提供するオンラインショップBOXPACK（以下「本サービス」といいます。）の利用条件を定めるものです。登録会員の皆さま（以下「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
              </p>
            </section>
            <section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第4条（売買契約）</h2>
              <ol className="list-decimal pl-4">
                ...
                <li>当社は、ユーザーが以下のいずれかの事由に該当する場合には、当該ユーザーに事前に通知することなく、前項の売買契約を解除することができるものとします。
                  <ol className="pl-4">
                    ...
                    <li>(2) 届け先不明や長期の不在のため商品の配送が完了しない場合</li>
                    <li>(3) その他当社とユーザーの信頼関係が損なわれたと認める場合</li>
                  </ol>
                </li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第5条（注文に関する重要事項）</h2>
              <ol className="list-decimal pl-4">
                <li>BOXPACKの組み立て木箱の注文は、内寸法でのご指定となります。外寸法でのご注文は承っておりません。</li>
                <li>板厚・組み合わせ順番により内寸が変わるため、外寸での受付は一切行っておりません。</li>
                <li>ユーザーは、サイズ入力時に内寸法であることを確認の上、ご注文いただくものとします。</li>
              </ol>
            </section>
            ...
            <section>
              ...
              <ol className="pl-4">
                ...
                <li>(2) 犯罪行為に関連する行為</li>
                <li>(3) 本サービスに含まれる著作権、商標権その他の知的財産権を侵害する行為</li>
                ...
                <li>(10) 当社のサービスに関連して、反社会的勢力に対して直接または間接に利益を供与する行為</li>
                <li>(11) その他、当社が不適切と判断する行為</li>
              </ol>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第8条（本サービスの提供の停止等）</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第9条（利用制限および登録抹消）</h2>
              <ul className="list-decimal pl-4">
                ...
                <ol className="pl-4">
                  ...
                  <li>(3) 決済手段として当該ユーザーが届け出たクレジットカードが利用停止となった場合</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第10条（退会）</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第11条（保証の否認および免責事項）</h2>
              <ol className="list-decimal pl-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第12条（サービス内容の変更等）</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第14条（個人情報の取扱い）</h2>
              <p className="mb-4">
              当社は、本サービスの利用によって取得する個人情報については、当サイトの「プライバシーポリシー」に従い適切に取り扱うものとします。
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第15条（通知または連絡）</h2>
              <ol className="list-decimal pl-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第16条（権利義務の譲渡の禁止）</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">第17条（準拠法・裁判管轄）</h2>
              <ol className="list-decimal pl-4">
