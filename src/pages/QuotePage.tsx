...
import { AlertCircle, Calculator, ShoppingCart, Download } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">板材選択</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <div className="space-y-4">
                {options.map((option) => (
                  <label
                    key={option.id}
                    className="flex items-start space-x-3 p-4 border-2 border-gray-200 rounded-lg hover:border-gray-400 transition-all cursor-pointer"
                  >
                    <input
                      type="checkbox"
